document.getElementById('myForm').addEventListener('submit', async function(event) {
    ...
    try {
        const response = await fetch('https://new-express-project-ifza2x7yk-benjis-projects-2d9aa7eb.vercel.app/submit', { // URL backend Express.js https://backend-fcnj4p8iv-benjis-projects-2d9aa7eb.vercel.app/submit
            method: 'POST',
